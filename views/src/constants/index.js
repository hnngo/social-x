...
export const ACT_AUTH_SIGNING_UP = "act_auth_signing_up";
...
// COMMENTS
export const ACT_CMT_UPLOADING_P = "act_cmt_uploading_p";
export const ACT_CMT_UPLOADING_F = "act_cmt_uploading_f";
